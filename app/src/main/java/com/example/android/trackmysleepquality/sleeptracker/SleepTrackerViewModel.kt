...
class SleepTrackerViewModel(val database: SleepDatabaseDao, application: Application) : AndroidViewModel(application) {
        ...
        // create a job that manages all coroutines
          private var viewModelJob = Job()

        //cancels all coroutines started by the ViewModel
        ...
        // create a navigation event livedata
        ...
        // since we want to call this function from the coroutine
        private suspend fun getTonightFromDatabase(): SleepNight? {
                // using the IO context
